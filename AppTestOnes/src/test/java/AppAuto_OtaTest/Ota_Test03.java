...
public class Ota_Test03 {
    ...
    public void Test_Start() throws MalformedURLException {
        ...
        desiredCapabilities.setCapability("udid", "172.18.28.160:5555");
        ...
        androidDriver = new AndroidDriver<>(new URL("http://172.18.28.194:160/wd/hub"), desiredCapabilities);
